...
public class GetRequestInformationQueryHandler : BaseQueryHandler, IRequestHandler<GetRequestInformationQuery, ApiResult>
{
    ...
    public async Task<ApiResult> Handle(GetRequestInformationQuery request, CancellationToken cancellationToken)
    {
        ...
        return new ApiSuccessResult<RequestValue>(value);
    }
}